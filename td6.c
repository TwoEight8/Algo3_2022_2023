...
void ajouteClientFichier(Client c, char *nomFichier)
{
    ...
    if (f == NULL)
    {
        printf("Erreur d'ouverture du fichier %s en mode a (ajout)\n", nomFichier);
        exit(1);
    }
...
void afficheClientsFichier(char *nomFichier)
{
    ...
    if (f == NULL)
    {
        printf("Erreur d'ouverture du fichier %s en mode r (lecture)\n", nomFichier);
        exit(1);
    }
    Client c;
...
void triClientsFichier(char *nomFichier)
{
    ...
    if (f == NULL)
    {
        printf("Erreur d'ouverture du fichier %s en mode w (écriture)\n", nomFichier);
        exit(1);
    }
    for (int i = 0; i < nombreClientsFichier(nomFichier); i++)
    {
